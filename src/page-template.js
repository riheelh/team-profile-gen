            ...
            <div class="col s4 m4 push-m4 s4">
                <div class="card grey lighten-4" style="padding: 1rem;">
                    <ul class="collection with-header ">
                        <li class="collection-header teal lighten-1 white-text"><h4>${teamArray[0].name} <i class="fab fa-jenkins" style="margin-right: 1rem; margin-left: 1rem;"></i></h4></li>
    ...
    function teamCard(teamArray) {
        let card=''; 
            ...
            <div class="col s4 m4">
                <div class="card grey lighten-4" style="padding: 1rem;">
                    <ul class="collection with-header ">
                        <li class="collection-header teal lighten-1 white-text"><h4>${teamArray[i].name} <i class="fas fa-cogs" style="margin-right: 1rem; margin-left: 1rem;"></i> </h4></li>
            ...
            <div class="col s4 m4">
                <div class="card grey lighten-4" style="padding: 1rem;">
                    <ul class="collection with-header ">
                        <li class="collection-header teal lighten-1 white-text"><h4>${teamArray[i].name} <i class="fas fa-graduation-cap" style="margin-right: 1rem; margin-left: 1rem;"></i></h4></li>
                        <li class="collection-item"><strong>Role: </strong>${teamArray[i].role}</li>
                        <li class="collection-item"><strong>ID: </strong>${teamArray[i].id}</li>
                        <li class="collection-item"><strong>Email: </strong><a href="mailto:${teamArray[i].email}">${teamArray[i].email}</a></li>
